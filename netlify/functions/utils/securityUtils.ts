/**
 * Server-Side Security Utilities (Node.js only)
 * Crypto-dependent functions for Netlify Functions
 * For browser-safe utilities, use src/utils/securityUtils.ts
 */

import crypto from 'crypto';

// ============================================
// SECURITY TOKEN GENERATION (Node.js only)
// ============================================

/**
 * Generates secure random token
 * Used for password reset, email verification, CSRF tokens, etc.
 */
 ...
 * Use this to store tokens in database (never store plain tokens)
 */
...
/**
 * Generates rate limit key for IP + endpoint
 */
