                  ...
                  {paymentDetails.slice(0, paymentBoxes.length).map((detail, idx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {completed && <span style={{ fontSize: 10, fontWeight: 500, opacity: 0.85 }}>Done</span>}
                      </button>
                    );
                  })}
                </div>
...
const MainPage: React.FC<MainPageProps> = ({ 
  ...
  return (
    ...
    <DriveRestoreModal
      ...
      currentUser={currentUser}
      onFilesRestored={() => {
        // intentionally left empty — reload is triggered by the Done/Restore More buttons in the modal
      }}
    />
    </>
  );
