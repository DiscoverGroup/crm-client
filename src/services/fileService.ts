...
export interface FileAttachment {
  ...
  source?: 'payment-terms' | 'visa-service' | 'insurance-service' | 'eta-service' | 'booking-voucher' | 'passport-info' | 'passport-visa-payment' | 'first-payment' | 'other-payment' | 'approval-invoice' | 'booking-confirmation' | 'account-relations' | 'sc-report'; // Track upload source
